...
extern "C" void hwy_add_f64x2(const double *a, const double *b, double *out) {
    hn::FixedTag<double, 2> d;
    auto va = hn::Load(d, a);
    auto vb = hn::Load(d, b);
    hn::Store(hn::Add(va, vb), d, out);
}
extern "C" void hwy_add_f64x3(const double *a, const double *b, double *out) {
...
extern "C" void hwy_add_f64x4(const double *a, const double *b, double *out) {
    hn::CappedTag<double, 4> d;
    const size_t lanes = hn::Lanes(d);
    auto va = hn::Load(d, a);
    auto vb = hn::Load(d, b);
    ...
    if (lanes < 4) {
        va = hn::Load(d, a + 2);
        vb = hn::Load(d, b + 2);
        hn::Store(hn::Add(va, vb), d, out + 2);
    }
}

extern "C" void hwy_add_f64x8(const double *a, const double *b, double *out) {
    ...
    if (lanes < 4) {
        va = hn::Load(d, a + 4);
        vb = hn::Load(d, b + 4);
        hn::Store(hn::Add(va, vb), d, out + 4);
        va = hn::Load(d, a + 6);
        vb = hn::Load(d, b + 6);
        hn::Store(hn::Add(va, vb), d, out + 6);
    }
}

extern "C" void hwy_add_f64(const double *a, const double *b, double *out, const size_t count) {
